...
class _HomePageState extends State<HomePage> {
  final List<String> contents = ['Início', 'Formulário', 'Cadastro'];
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              if (constraints.maxWidth > 1200) {
                ...
                rightPosition = (MediaQuery.of(context).size.width - containerWidth * 0.4) / 3;
                rightSetence = 50;
                bottomSetence = 110;
                rightButton = 40;
                bottomButton = 50;
                heightContainer = MediaQuery.of(context).size.height * 0.6;
                topImage = MediaQuery.of(context).size.height * 0.15;
                fontSizeTitle = 30;
                fontSizeSubtitle = 16;
                          ...
                          child: Builder(builder: (context) {
                            return Container(
                              decoration: BoxDecoration(
                                boxShadow: [
                                  BoxShadow(
                                    color: const Color.fromARGB(66, 104, 113, 166).withOpacity(0.3),
                                    spreadRadius: 0,
                                    blurRadius: 15,
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: const Color.fromARGB(255, 146, 196, 211),
