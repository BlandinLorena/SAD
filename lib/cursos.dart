...
Future<List<Denuncia>> fetchDenuncias() async {
  try {
    ...
    if (response.statusCode == 200) {
      ...
      return List<Denuncia>.from(l.map((model) => Denuncia.fromJson(model)));
    } else {
...
class _CursosState extends State<Cursos> {
  ...
  void initState() {
    super.initState();
    futureDenuncias = fetchDenuncias(); 
  }
      ...
      body: Container(
        ...
        child: Row(
          children: [
                    ...
                    children: [
                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          return ListTile(
                            title: Text('INFORMÁTICA', style: TextStyle(color: Colors.white, fontSize: constraints.maxWidth < 500 ? 12.0 : 22.0)),
                            onTap: () {
                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          return Column(
                            children: [
                              ListTile(
                                title: Text('MECATRÔNICA', style: TextStyle(color: Colors.white, fontSize: constraints.maxWidth < 500 ? 12.0 : 22.0)),
                                onTap: () {
                                  Navigator.pushNamed(context, 'meca');
                                },
                              ),
                              ListTile(
                                title: Text('MODA', style: TextStyle(color: Colors.white, fontSize: constraints.maxWidth < 500 ? 12.0 : 22.0)),
                                onTap: () {
                                  Navigator.pushNamed(context, 'moda');
                                },
                              ),
                              ListTile(
                                title: Text('Geral', style: TextStyle(color: const Color.fromARGB(255, 255, 169, 108), fontSize: constraints.maxWidth < 500 ? 12.0 : 22.0, fontWeight: FontWeight.bold)),
                                onTap: () {
            ...
            // Relatos - Exibição das denúncias
            Expanded(
