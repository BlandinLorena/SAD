...
class Meca extends StatefulWidget {
  const Meca({super.key});

  @override
  State<Meca> createState() => _MecaState();
}
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      List<Denuncia> denunciasFiltradas = denuncias.where((denuncia) {
        return denuncia.turmaId == '1' || denuncia.turmaId == '2' || denuncia.turmaId == '3';
      }).toList();
...
class _MecaState extends State<Meca> {
